...
parser.add_argument("--image", default="./sample.bmp", type=str, help="image name")
...
im_gt_ycbcr = cv2.imread(opt.image)
im_gt_ycbcr = cv2.cvtColor(im_gt_ycbcr, cv2.COLOR_RGB2YCrCb)
# im_gt_ycbcr = imread("Set5/" + opt.image + ".bmp", mode="YCbCr")
im_b_ycbcr = cv2.imread(opt.image + "_scale_" + str(opt.scale) + ".bmp")
